...
<body>
	<div class="header" style="background-color: orange;">
		<h1 style="font-family: serif; color: black;">TUGAS AKHIR PEMROGRAMAN WEB</h1>
		<p style="font-size: 18px; color: black;">Selamat Datang di Website Saya</p>
	</div>
	...
	<div class="rightcolumn" style="background-color: white" >
	        ...
	        ?>	    
	        <br>
	<table style="border: 5px solid #000000" align="center" cellpadding="5">
		<tr bgcolor="bluesky">
	...
	<div class="row" style="background-color: white">
		<div class="centercolumn" style="background-color: white">
			<div class="card" style="background-color: white;">
				<h3 style="font-family: Times New roman">Hallo Perkenalkan Saya Kevin Razan Saputra</h3>
				<p>Saya Kuliah Di Universitas Ahmad Dahlan Fakultas Teknologi Industri Prodi Teknik Informatika.</p>
				<div>
					<center><img src="saya.jpeg" width="300px"></center>
				</div>
				<div class="card" style="background-color: lightgray;">
		    		<h3>Follow Me</h3>
		    		<img src="IG.png" width="30px">
		    		<a href="https://www.instagram.com/kevinrazann/">kevinrazann</a><br><br>
		    		<p>Copyright © kevinrazann 2022</p>
	       		</div>
